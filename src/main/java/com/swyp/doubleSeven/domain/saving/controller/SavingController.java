...
//    @AuthCheck
    @PostMapping
    public ResponseEntity<SavingResponse> createVirtualItem (@RequestBody SavingRequest savingRequest, @RequestParam("memberId") Integer currentMemberId) {
...
//    @VaildateResourceOwner
    ...
    public ResponseEntity<String> deleteVirtualItem (
            @Parameter(description = "가상 소비 ID", in = ParameterIn.PATH) @PathVariable Integer savingId, @RequestParam("memberId") Integer currentMemberId) {
//        Integer currentMemberId = authenticationUtil.getCurrentMemberId();
